    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/compileconnected/textvalidation/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/compileconnected/textvalidation.git")
                    developerConnection.set("scm:git:ssh://github.com/compileconnected/textvalidation.git")
                    url.set("https://github.com/compileconnected/textvalidation/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/compileconnected/textvalidation/issues")
                }
            }
        }
    }
