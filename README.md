...
![Build](https://github.com/CompileConnected/text-validation/workflows/Pre%20Merge%20Checks/badge.svg)
...
- [ ] Choose a [LICENSE](https://github.com/CompileConnected/text-validation/community/license/new?branch=main).
- [ ] Set your `ORG_GRADLE_PROJECT_NEXUS_USERNAME`, `ORG_GRADLE_PROJECT_NEXUS_PASSWORD`, `ORG_GRADLE_PROJECT_SIGNING_KEY` and `ORG_GRADLE_PROJECT_SIGNING_PWD` secrets in [Settings](https://github.com/CompileConnected/text-validation/settings/secrets/actions).
